...
- [x] Schema evolution policy — when adding fields, do we use `COALESCE`/default, or do we migrate? → `SCHEMA_EVOLUTION_POLICY.md` resolves this. Policy: COALESCE/default in reducers, NOT migrations.
