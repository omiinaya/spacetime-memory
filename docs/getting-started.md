...
This guide covers SDK usage examples. For setup instructions (installing SpacetimeDB, building the module, configuring embeddings), see the **[Setup section in README.md](https://github.com/omiinaya/spacetime-memory#setup)** which has two paths:

- [Quick Start (I have a running SpacetimeDB)](https://github.com/omiinaya/spacetime-memory#quick-start-i-have-a-running-spacetimedb) — just `pip install` and go
- [Full Stack Setup (from scratch)](https://github.com/omiinaya/spacetime-memory#full-stack-setup-from-scratch--need-to-run-stdb) — set up STDB for the first time
