...
/** Type guard: value has a `props.children` key */
function hasPropsWithChildren(value: unknown): value is { props: { children?: React.ReactNode } } {
...
function extractTextContent(children: React.ReactNode): string {
  ...
  if (hasPropsWithChildren(children)) {
