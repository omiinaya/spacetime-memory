...
const navItems: NavItem[] = [
  ...
  { href: '/memory-meta', label: 'Memory Meta', icon: ShieldCheck },
  { href: '/documents', label: 'Documents', icon: FileText },
  { href: '/search', label: 'Search', icon: Search },
  { href: '/query', label: 'Smart Query', icon: Wand2 },
  { href: '/webhooks', label: 'Webhooks', icon: Webhook },
  { href: '/observations', label: 'Observations', icon: Lightbulb },
  { href: '/context-tree', label: 'Context Tree', icon: Globe },
  { href: '/review', label: 'Review', icon: BookOpen },
  { href: '/export-import', label: 'Export/Import', icon: Download },
  { href: '/task-queue', label: 'Task Queue', icon: ListChecks },
  { href: '/pipelines', label: 'Pipelines', icon: GitBranch },
  { href: '/rbac', label: 'RBAC', icon: Shield },
  { href: '/skills-mods', label: 'Skills & Mods', icon: Puzzle },
  { href: '/ontology', label: 'Ontology', icon: Layers },
  { href: '/trust-dashboard', label: 'Trust Dashboard', icon: ShieldCheck },
  { href: '/proxy-metrics', label: 'Proxy Metrics', icon: Gauge },
  { href: '/metrics', label: 'Metrics Dashboard', icon: BarChart3 },
  { href: '/pattern-detection', label: 'Pattern Detection', icon: BarChart3 },
  { href: '/reflection-loop', label: 'Reflection Loop', icon: BrainCircuit },
  { href: '/reasoning-tiers', label: 'Reasoning Tiers', icon: Layers },
  { href: '/cognitive-ops', label: 'Cognitive Ops', icon: Cpu },
  { href: '/memfs', label: 'MemFS', icon: FolderTree },
