/**
 * Smoke test for SkillsModsPage component.
 */
...
import SkillsModsPage from '@/pages/SkillsModsPage';

describe('SkillsModsPage', () => {
  it('renders without crashing', async () => {
    const { container } = render(React.createElement(SkillsModsPage));
