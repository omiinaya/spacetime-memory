/**
 * Smoke test for ContextTreeEditor component.
 */
...
import ContextTreeEditor from '@/pages/ContextTreeEditor';

describe('ContextTreeEditor', () => {
  it('renders without crashing', async () => {
    const { container } = render(React.createElement(ContextTreeEditor));
