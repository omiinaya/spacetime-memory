/**
 * Smoke test for SessionReasoning component.
 */
...
import SessionReasoning from '@/pages/SessionReasoning';

describe('SessionReasoning', () => {
  it('renders without crashing', async () => {
    const { container } = render(React.createElement(SessionReasoning));
