/**
 * Smoke test for MemoryMetaEditor component.
 */
...
import MemoryMetaEditor from '@/pages/MemoryMetaEditor';

describe('MemoryMetaEditor', () => {
  it('renders without crashing', async () => {
    const { container } = render(React.createElement(MemoryMetaEditor));
