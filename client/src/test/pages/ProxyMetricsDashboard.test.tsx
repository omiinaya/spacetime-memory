/**
 * Smoke test for ProxyMetricsDashboard component.
 */
...
import ProxyMetricsDashboard from '@/pages/ProxyMetricsDashboard';

describe('ProxyMetricsDashboard', () => {
  it('renders without crashing', async () => {
    const { container } = render(React.createElement(ProxyMetricsDashboard));
