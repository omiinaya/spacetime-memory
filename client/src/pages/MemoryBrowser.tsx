...
import { Database, Search as SearchIcon, Filter, AlertCircle, Tag, Lock } from 'lucide-react';
...
export default function MemoryBrowser() {
  ...
  const { data: metas } = useTable<MemoryMetaRow>('memory_meta');
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Search memories by content, summary, type, or category..."
            className="pl-9"
            value={searchTerm}
