...
def aaak_compress_cmd(text: str | None, file: str | None, pipe: bool) -> None:
    ...
    if pipe or (not text and not file and sys.stdin.isatty() is False):
        ...
        _root.console.print("[red]Error:[/red] provide text, --file, or pipe input")
        sys.exit(1)
    ...
    if pipe or file:
        ...
        _root.console.print(compressed, highlight=False)
    else:
...
def aaak_decompress_cmd(text: str | None, file: str | None, pipe: bool) -> None:
    ...
    if pipe or file:
        _root.console.print(decompressed, highlight=False)
    else:
        _root.console.print(f"[bold]Original:[/bold] {text}")
        _root.console.print(f"[bold]Decompressed:[/bold] {decompressed}")
...
def aaak_ratio_cmd(text: str | None, file: str | None, pipe: bool) -> None:
    ...
    _root.console.print(f"AAAK ratio: [cyan]{ratio:.1%}[/cyan] "
