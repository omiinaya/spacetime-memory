...
def _make_sql_resp(rows):
    ...
    Supports both ``_sql()`` (reads ``.text``) and ``_call_with_result()``
    (reads ``.json()["result"]``) paths.
    """
...
class TestSearchTemporalFilter:
    ...
    def test_search_temporal_filter_from(self, mock_http_client):
        ...
        mock_http_client._http.post.side_effect = _search_side_effect(
            tantivy_hits=[
                {"entity_id": "1", "content": "old memory", "created_at": 100, "score": 0.5},
                {"entity_id": "2", "content": "new memory", "created_at": 200, "score": 0.9},
            ],
            sql_rows=[
    ...
    def test_search_temporal_filter_both(self, mock_http_client):
        ...
        mock_http_client._http.post.side_effect = _search_side_effect(
            tantivy_hits=[
                {"entity_id": "1", "content": "too old", "created_at": 50, "score": 0.3},
                {"entity_id": "2", "content": "just right", "created_at": 120, "score": 0.8},
                {"entity_id": "3", "content": "too new", "created_at": 200, "score": 0.7},
            ],
            sql_rows=[
    ...
    def test_search_explicit_before_overrides_temporal_filter(self, mock_http_client):
        ...
        mock_http_client._http.post.side_effect = _search_side_effect(
            tantivy_hits=[
                {"entity_id": "1", "content": "memory A", "created_at": 100, "score": 0.5},
                {"entity_id": "2", "content": "memory B", "created_at": 200, "score": 0.8},
                {"entity_id": "3", "content": "memory C", "created_at": 300, "score": 0.9},
            ],
            sql_rows=[
    ...
    def test_search_no_created_at_filtered_out(self, mock_http_client):
        ...
        mock_http_client._http.post.side_effect = _search_side_effect(
            tantivy_hits=[
                {"entity_id": "1", "content": "no timestamp", "score": 0.1},
                {"entity_id": "2", "content": "has timestamp", "created_at": 100, "score": 0.9},
            ],
            sql_rows=[
