...
class TestExpandQueryErrors:
    ...
    def test_malformed_response_missing_choices(self):
        ...
        with patch("httpx.post", return_value=resp), pytest.raises(KeyError):
            expand_query("python", api_key="sk-test")
    ...
    def test_malformed_response_empty_choices(self):
        ...
        with patch("httpx.post", return_value=resp), pytest.raises(IndexError):
            expand_query("python", api_key="sk-test")
...
class TestEnvVarFallback:
    ...
    def test_env_endpoint(self):
        ...
        with patch("httpx.post", return_value=mock_resp) as mock_post, patch.dict(
            "os.environ",
            {
