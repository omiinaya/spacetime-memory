...
| Tool | Description | Parameters |
|---|---|---|
| `store_memory` | Store a new memory with optional tier override and image attachments | `workspace_id`, `peer_id`, `observer_id`, `memory_type`, `content`, `summary`, `entities_json`, `confidence`, `source_session_id`, `source_message_id`, `tier`, `images_json` |
